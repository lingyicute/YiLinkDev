...
import com.v2ray.yilink.service.SubscriptionUpdater
import com.v2ray.yilink.util.Utils
import com.v2ray.yilink.viewmodel.SettingsViewModel
...
//
//            feedback.onClick {
//                Utils.openUri(activity, "https://github.com/lingyicute/YiLink/issues")
//            }
//            tgGroup.onClick {
...
//            }
        ...
        private fun configureUpdateTask(interval: Long) {
            val rw = RemoteWorkManager.getInstance(YilinkApplication.application)
    ...
    fun onModeHelpClicked(view: View) {
        Utils.openUri(this, AppConfig.YiLinkWikiMode)
    }
}
