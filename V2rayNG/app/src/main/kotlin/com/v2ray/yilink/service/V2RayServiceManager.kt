...
import com.v2ray.yilink.extension.toSpeedString
import com.v2ray.yilink.extension.toast
import com.v2ray.yilink.ui.MainActivity
...
object V2RayServiceManager {
        ...
        override fun onReceive(ctx: Context?, intent: Intent?) {
            ...
            when (intent?.action) {
                Intent.ACTION_SCREEN_OFF -> {
                    Log.d(YILINK_PACKAGE, "SCREEN_OFF, stop querying stats")
                    stopSpeedNotification()
                }
                Intent.ACTION_SCREEN_ON -> {
                    Log.d(YILINK_PACKAGE, "SCREEN_ON, start querying stats")
                    startSpeedNotification()
                }
            }
        }
        ...
        GlobalScope.launch(Dispatchers.IO) {
            ...
            if (v2rayPoint.isRunning) {
                try {
                    ...
                    Log.d(YILINK_PACKAGE, "measureV2rayDelay: $e")
    ...
    private fun showNotification() {
        ...
        stopV2RayIntent.`package` = YILINK_PACKAGE
