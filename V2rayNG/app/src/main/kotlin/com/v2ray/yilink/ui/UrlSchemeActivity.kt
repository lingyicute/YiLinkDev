...
import com.v2ray.yilink.databinding.ActivityLogcatBinding
...
class UrlSchemeActivity : BaseActivity() {
    ...
    private fun importSubscription(url: String, name: String) {
        ...
        val check = YilinkConfigManager.importSubscription(name, decodedUrl)
    ...
    private fun importConfig(shareUrl: String) {
        val count = YilinkConfigManager.importBatchConfig(shareUrl, "", false)
        if (count > 0) {
