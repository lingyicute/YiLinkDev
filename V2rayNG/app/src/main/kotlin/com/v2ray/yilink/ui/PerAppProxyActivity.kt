...
import com.v2ray.yilink.databinding.ActivityBypassListBinding
import com.v2ray.yilink.dto.AppInfo
import com.v2ray.yilink.extension.toast
import com.v2ray.yilink.extension.v2RayApplication
import com.v2ray.yilink.util.AppManagerUtil
            ...
            if (binding.switchBypassApps.isChecked) {
                adapter?.let {
                    it.apps.forEach block@{
                        val packageName = it.packageName
                        Log.d(YILINK_PACKAGE, packageName)
