 ...
 */
object AppConfig {
    const val YILINK_PACKAGE = BuildConfig.APPLICATION_ID
    const val DIR_ASSETS = "assets"
    const val DIR_BACKUPS = "backups"

    // legacy
    const val YILINK_CONFIG = "yilink_config"
    ...
    const val BROADCAST_ACTION_SERVICE = "com.v2ray.yilink.action.service"
    const val BROADCAST_ACTION_ACTIVITY = "com.v2ray.yilink.action.activity"
    const val BROADCAST_ACTION_WIDGET_CLICK = "com.v2ray.yilink.action.widget.click"
