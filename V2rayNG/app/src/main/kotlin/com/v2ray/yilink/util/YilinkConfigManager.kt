...
import com.v2ray.yilink.AppConfig.YILINK_CONFIG
import com.v2ray.yilink.AppConfig.PROTOCOL_HTTPS
import com.v2ray.yilink.AppConfig.PROTOCOL_HTTP
import com.v2ray.yilink.AppConfig.WIREGUARD_LOCAL_ADDRESS_V4
import com.v2ray.yilink.AppConfig.WIREGUARD_LOCAL_MTU
import com.v2ray.yilink.R
import com.v2ray.yilink.dto.*
import com.v2ray.yilink.dto.V2rayConfig.Companion.DEFAULT_SECURITY
import com.v2ray.yilink.dto.V2rayConfig.Companion.TLS
import com.v2ray.yilink.util.MmkvManager.KEY_SELECTED_SERVER
import java.net.URI
import java.util.*
import java.lang.reflect.Type
import com.v2ray.yilink.extension.idnHost
import com.v2ray.yilink.extension.removeWhiteSpace

object YilinkConfigManager {
    ...
    fun migrateLegacyConfig(c: Context): Boolean? {
        try {
            ...
            val context = defaultSharedPreferences.getString(YILINK_CONFIG, "")
    ...
    private fun migrateVmessBean(yilinkConfig: YilinkConfig, sharedPreferences: SharedPreferences) {
        yilinkConfig.vmess.forEachIndexed { index, vmessBean ->
            ...
            if (type == EConfigType.CUSTOM) {
                val jsonConfig = sharedPreferences.getString(YILINK_CONFIG + vmessBean.guid, "")
                val v2rayConfig = try {
    ...
    private fun tryResolveResolveSip002(str: String, config: ServerConfig): Boolean {
        try {
            ...
            if (query != "") {
                ...
                Log.d(AppConfig.YILINK_PACKAGE, pairs.toString())
                for (pair in pairs) {
                ...
                Log.d(AppConfig.YILINK_PACKAGE, queryPairs.toString())
                var sni: String? = ""
            ...
            Log.d(AppConfig.YILINK_PACKAGE, e.toString())
            return false
        }
    }
     ...
     * upgrade
     */
    private fun upgradeServerVersion(vmess: YilinkConfig.VmessBean): Int {
        try {
