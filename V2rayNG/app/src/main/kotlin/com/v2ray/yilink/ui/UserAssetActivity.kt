...
import com.v2ray.yilink.databinding.ActivitySubSettingBinding
import com.v2ray.yilink.databinding.ItemRecyclerUserAssetBinding
import com.v2ray.yilink.dto.AssetUrlItem
import com.v2ray.yilink.extension.toTrafficString
...
class UserAssetActivity : BaseActivity() {
    ...
    private fun downloadGeo(item: AssetUrlItem, timeout: Int, httpPort: Int): Boolean {
        ...
        //Log.d(AppConfig.YILINK_PACKAGE, url)
        ...
        try {
            ...
            Log.e(AppConfig.YILINK_PACKAGE, Log.getStackTraceString(e))
            return false
        } finally {
            conn?.disconnect()
        }
